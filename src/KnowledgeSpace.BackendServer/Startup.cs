...
namespace KnowledgeSpace.BackendServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //3. Set up builder IdenityServer with InMemory Configuration
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // use IdentityServer include a call to UseAuthentication
            app.UseStaticFiles();
            ...
            {
                endpoints.MapDefaultControllerRoute(); // ăn theo controller/action
